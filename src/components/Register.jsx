...
function Register(){
    ...
    const handleSubmit= async(e)=>{
        //setLoading(true);(this was causing an error because e.preventDefault must come first or for some other reason)
        e.preventDefault();
        setLoading(true)
        ...
        <div className="h-screen flex mt-10 justify-center">
            <div className="p-5 w-full md:w-1/3">
                ...
                <form onSubmit={handleSubmit} > 
                    ...
                    <Input autoComplete='off' label='Username' id='username' type='text' placeholder='username' value={username} onChange={(e)=>setUsername(e.target.value)}/>
                    ...
                    <button disabled={!validusername || !validpassword} type='submit' className="disabled:opacity-50 bg-indigo-400 p-3 rounded-md block mt-5 w-full text-center">Sign Up</button>
